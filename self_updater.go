...
func GetInstallerDownloadLink() string {
	const BaseUrl = "https://github.com/PaperTobi/Skibidilotl/releases/latest/download/"
	switch runtime.GOOS {
	case "windows":
		filename := Ternary(buildinfo.UiType == buildinfo.UiTypeCli, "SkibidilotlCli.exe", "Skibidilotl.exe")
		return BaseUrl + filename
	case "darwin":
		return BaseUrl + "Skibidilotl.MacOS.zip"
	case "linux":
		return BaseUrl + "SkibidilotlCli-linux"
	default:
		return ""
	}
}
